...
const es: Dict = {
  ...
  batchPreviewGroup:      (files, txns) => `${files} archivo${files !== 1 ? 's' : ''} · ${txns} transacción${txns !== 1 ? 'es' : ''}`,
  batchPreviewFileSep:    (filename) => `— ${filename} —`,
  batchConfirmAllBtn:     (n) => `Confirmar e importar todo (${n} transacción${n !== 1 ? 'es' : ''})`,
  ...
  batchSummaryNewTx:      (n) => `${n} transacción${n !== 1 ? 'es' : ''} nueva${n !== 1 ? 's' : ''}`,
